function Footer() {
  return (
    <footer className="bg-black py-6 border-2 flex items-center justify-between border-bg-primary">
      <div className="flex  items-center">
        <img
          ...
          className=" px-4 h-12  cursor-pointer"
        />
        <div>
          <p className=" px-4 gradientText text-sm">
            GTA LANDING PAGE MADE BY RAHUL NAYAK
          </p>
          <p className=" px-4 gradientText text-sm">Roll No: 125CS0097</p>
        </div>
      </div>
      <div>
